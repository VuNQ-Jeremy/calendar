    ...
    list.length
      ? React.createElement(
          ...
          list.map((m) => {
            ...
            return React.createElement(
              XC,
              { key: m.id, interactive: true },
              React.createElement(
                'div',
                { className: 'm-spread', style: { alignItems: 'flex-start', marginBottom: 12 } },
                React.createElement(
                  'div',
                  {
                    className: 'iconwrap',
                  ...
                  React.createElement(MIcon, { name: mt.icon, size: 20 }),
                ),
                React.createElement(
                  'button',
                  {
                  ...
                  React.createElement(MIcon, { name: m.favorite ? 'starFill' : 'star', size: 18 }),
                ),
              ),
              React.createElement(
                'h3',
                { style: { margin: '0 0 6px', fontSize: 'var(--text-md)' } },
                m.title,
              ),
              React.createElement(
                'div',
                { className: 'lrow__meta', style: { marginBottom: 14 } },
              ...
              React.createElement(
                ...
                isLink
                  ? React.createElement(
                      ...
                      React.createElement(MIcon, { name: 'link', size: 14 }),
                      t('mat_open_link'),
                    )
                  : React.createElement(
                      'button',
                      ...
                      React.createElement(MIcon, { name: 'download', size: 15 }),
                      t('mat_download'),
                    ),
                React.createElement(
                  'div',
                  ...
                  React.createElement(
                    XIB,
                    { label: t('edit'), size: 'sm', onClick: () => setModal({ ...m }) },
                    React.createElement(MIcon, { name: 'edit', size: 15 }),
                  ),
                  React.createElement(
                    XIB,
                    { label: t('delete'), size: 'sm', onClick: () => remove('materials', m.id) },
                    React.createElement(MIcon, { name: 'trash', size: 15 }),
                  ),
                ),
              ),
            );
...
function MaterialModal({ draft, setDraft, onClose, onSave, classes }) {
  ...
  const onFile = (e) => {
    ...
    if (f.size > 4 * 1024 * 1024) {
      ...
      return;
    } // too big to embed; keep name only
...
function ThemeColorRow({ value, label, sub, onChange }) {
  return React.createElement(
    ...
    React.createElement(
      'span',
      { className: 'm-mono m-muted', style: { fontSize: 'var(--text-xs)' } },
...
function CalendarThemePanel() {
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { className: 'theme-preset', style: { marginBottom: 20 } },
      Object.entries(PRESETS).map(([key, p]) =>
        React.createElement(
          ...
          React.createElement(
            ...
            p.swatches.map((s, i) =>
              React.createElement('span', { key: i, style: { background: s } }),
            ),
          ),
    ...
    React.createElement(
      'div',
      { className: 'mochi-eyebrow', style: { marginBottom: 4 } },
      t('theme_finetune'),
    ),
    React.createElement(ThemeColorRow, {
      value: theme.bg,
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'label',
          { className: 'mochi-field__label', style: { margin: 0 } },
          t('theme_opacity'),
        ),
        React.createElement(
          'span',
    ...
    theme.bgImage &&
      React.createElement(
        XBtn,
        {
          variant: 'ghost',
          size: 'sm',
          iconLeft: React.createElement(MIcon, { name: 'x', size: 15 }),
...
function ProfileScreen({ user, onSave, onLogout }) {
  ...
  return React.createElement(
    'div',
    { className: 'content', style: { maxWidth: 920 } },
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        user.avatar &&
          React.createElement(
            ...
            React.createElement(
              XBtn,
              { variant: 'ghost', size: 'sm', onClick: () => onSave({ avatar: '' }) },
        ...
        React.createElement(
          'div',
          { className: 'm-muted', style: { fontSize: 'var(--text-sm)', marginBottom: 16 } },
      ...
      React.createElement(
        'div',
        { className: 'm-stack', style: { gap: 20 } },
        React.createElement(
          XC,
          null,
          React.createElement(
            'h2',
            { style: { margin: '0 0 16px', fontSize: 'var(--text-xl)' } },
            t('prof_personal'),
          ),
          React.createElement(
            'div',
          ...
          React.createElement(
            'div',
            { className: 'm-row', style: { gap: 12, marginTop: 6 } },
            React.createElement(
              XBtn,
              { variant: 'primary', onClick: doSave, disabled: !dirty },
        ...
        React.createElement(
          ...
          React.createElement(
            'h2',
            { style: { margin: '0 0 4px', fontSize: 'var(--text-xl)' } },
            t('prof_account'),
          ),
          React.createElement(
            'p',
            { className: 'm-muted', style: { fontSize: 'var(--text-sm)', marginTop: 0 } },
            t('prof_account_sub'),
          ),
          React.createElement(
            'div',
            { className: 'm-row', style: { gap: 12 } },
            React.createElement(
              XBtn,
              {
                variant: 'danger',
                iconLeft: React.createElement(MIcon, { name: 'logout', size: 16 }),
                onClick: onLogout,
              },
              t('prof_logout'),
            ),
