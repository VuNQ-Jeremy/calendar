...
function MaterialsScreen() {
  ...
  return React.createElement('div', { className: 'content' },
    ...
    React.createElement('div', { className: 'cal-toolbar' },
      React.createElement('div', { style: { minWidth: 180 } }, React.createElement(MSelect, { value: filterClass, onChange: setFilterClass, options: [{ value: 'all', label: 'All classes' }, ...data.classes.map(c => ({ value: c.id, label: c.name }))] })),
      React.createElement('div', { style: { minWidth: 150 } }, React.createElement(MSelect, { value: filterType, onChange: setFilterType, options: [{ value: 'all', label: 'All types' }, ...Object.entries(MAT_TYPES).map(([k, v]) => ({ value: k, label: v.label }))] })),
    ...
    ) : React.createElement(XC, null, React.createElement(Empty, { icon: 'folder', title: 'No materials found', sub: 'Try a different filter, or add a new material.' })),
...
function MaterialModal({ draft, setDraft, onClose, onSave, classes }) {
  ...
  return React.createElement(Modal, {
    ...
    React.createElement('div', { className: 'm-grid cols-2', style: { gap: 14 } },
      React.createElement(MSelect, { label: 'Type', value: draft.type, onChange: v => set('type', v), options: Object.entries(MAT_TYPES).map(([k, v]) => ({ value: k, label: v.label })) }),
      React.createElement(MSelect, { label: 'Class', value: draft.classId, onChange: v => set('classId', v), options: classes.map(c => ({ value: c.id, label: c.name })) }),
    ),
    isLink
      ? React.createElement('div', { className: 'mochi-field' },
...
function ProfileScreen({ user, onSave, onLogout }) {
  ...
  return React.createElement('div', { className: 'content', style: { maxWidth: 920 } },
    React.createElement(PageHeader, { title: 'Your profile', subtitle: 'Manage your name, avatar, and contact details' }),
    React.createElement('div', { className: 'm-grid profile-grid', style: { gridTemplateColumns: 'minmax(0,300px) minmax(0,1fr)' } },
      ...
      React.createElement(XC, { style: { textAlign: 'center' } },
        ...
        React.createElement('div', { style: { display: 'grid', placeItems: 'center' } },
          React.createElement(ColorPicker, { label: 'Avatar color', value: f.color, onChange: v => set('color', v) }),
        ),
      ),
      // Details card
