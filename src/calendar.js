  ...
  return React.createElement(
    Modal,
    {
      ...
      footer: React.createElement(
        ...
        !isNew &&
          React.createElement(
            CBtn,
            {
              ...
              iconLeft: React.createElement(MIcon, { name: 'trash', size: 16 }),
            },
            t('delete'),
          ),
        ...
        React.createElement(
          CBtn,
          { variant: 'primary', onClick: () => onSave(f) },
    ...
    React.createElement(
      'div',
      { className: 'm-grid cols-3', style: { gap: 14 } },
      React.createElement(
        'div',
        { className: 'mochi-field' },
        ...
        return React.createElement(
          ...
          dayEvents.length > 3 &&
            React.createElement(
              'div',
              { className: 'mmore' },
              t('cal_more', { n: dayEvents.length - 3 }),
            ),
        );
      }),
    ),
...
function TimeGrid({ cursor: _cursor, days, events, onPick, onCreate, onMove }) {
  ...
  return React.createElement(
    'div',
    { className: 'tgrid', style: { '--hr-h': HR_H + 'px' } },
    React.createElement(
      'div',
      { className: 'tgrid__head', style: { gridTemplateColumns: gridTpl } },
      React.createElement('div', { className: 'tgrid__corner' }),
      dayList.map((d, i) => {
        const isToday = iso(d) === today;
        return React.createElement(
          'div',
          { key: i, className: 'tgrid__dayhd' + (isToday ? ' is-today' : '') },
          React.createElement(
            'div',
            { className: 'w' },
            dayList.length > 1 ? dowMon[i % 7] : dow[d.getDay()],
          ),
          isToday
            ? React.createElement('div', { className: 'ddot' }, d.getDate())
            : React.createElement('div', { className: 'd' }, d.getDate()),
        );
      }),
    ),
    React.createElement(
      'div',
      { className: 'tgrid__body', style: { gridTemplateColumns: gridTpl }, ref: bodyRef },
      React.createElement(
        'div',
        { className: 'tgrid__times' },
        HOURS.map((h) =>
          React.createElement('div', { key: h, className: 'tgrid__timelabel' }, fmtTime(`${h}:00`)),
        ),
      ),
      dayList.map((d, ci) => {
        const dk = iso(d);
          ...
          dayEvents.map((e, j) => {
            ...
            return React.createElement(
              ...
              height > 34 &&
                React.createElement(
                  'div',
                  { className: 'tev__time', style: { color: c.ink } },
...
function AgendaView({ cursor: _cursor, events, onPick }) {
  ...
  return React.createElement(
    ...
    days.map(({ d, dk, list }) =>
      React.createElement(
        'div',
        { key: dk, className: 'agenda__day' },
        React.createElement(
          'div',
          { className: 'agenda__date' + (dk === today ? ' is-today' : '') },
          React.createElement(
            'div',
            { className: 'agenda__dwk' },
            dk === today ? t('today') : dow[d.getDay()],
          ),
        ...
        React.createElement(
          ...
          list.map((e, j) => {
            ...
            return React.createElement(
              ...
              e.recurrence !== 'none' &&
                React.createElement(MIcon, { name: 'repeat', size: 14, style: { color: c.ink } }),
            );
          }),
        ),
      ),
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          CIBtn,
          { label: t('close'), size: 'sm', onClick: onClose },
          React.createElement(MIcon, { name: 'x', size: 18 }),
        ),
      ),
      React.createElement(
        'div',
...
function CalendarScreen() {
  ...
  return React.createElement(
    ...
    React.createElement(PageHeader, {
      ...
      actions: React.createElement(
        ...
        React.createElement(
          ...
          {
            variant: 'secondary',
            iconLeft: React.createElement(MIcon, { name: 'palette', size: 17 }),
    ...
    React.createElement(
      ...
      React.createElement(
        CIBtn,
        { label: 'Previous', variant: 'solid', size: 'sm', onClick: () => go(-1) },
        React.createElement(MIcon, { name: 'chevronLeft', size: 18 }),
      ),
      React.createElement(
        CIBtn,
        { label: 'Next', variant: 'solid', size: 'sm', onClick: () => go(1) },
        React.createElement(MIcon, { name: 'chevronRight', size: 18 }),
      ),
      React.createElement(
        CBtn,
        { variant: 'secondary', size: 'sm', onClick: () => setCursor(new Date(TODAY)) },
        t('today'),
      ),
      React.createElement('span', { className: 'title' }, title),
      React.createElement('span', { style: { flex: 1 } }),
      React.createElement(CTabs, {
        value: view,
        onChange: setView,
        tabs: [
    ...
    React.createElement(
      'div',
      { className: 'calwrap', style: calStyle },
      theme.bgImage &&
        React.createElement('div', {
      ...
      view === 'agenda' &&
        React.createElement(AgendaView, { cursor, events: data.events, onPick: openEdit }),
    ),
    React.createElement(
      'div',
      { className: 'legend' },
      data.classes.map((c) => {
        ...
        return React.createElement(
          'div',
          { key: c.id, className: 'legend__item' },
          React.createElement('span', {
