...
function ClassesScreen() {
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { className: 'm-grid cols-3' },
      data.classes.map((c) => {
        const col = colorOf(c.color);
        const roster = studentsOf(c);
        return React.createElement(
          MC,
          { key: c.id, interactive: true, style: { padding: 0, overflow: 'hidden' } },
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              { className: 'm-spread', style: { alignItems: 'flex-start' } },
              React.createElement(
                'div',
                { style: { flex: 1, minWidth: 0 } },
                React.createElement(
                  'h3',
                  { style: { margin: '0 0 6px', fontSize: 'var(--text-lg)' } },
                  c.name,
                ),
              ...
              React.createElement(
                'div',
                { className: 'lrow__actions', style: { flexShrink: 0 } },
                React.createElement(
                  MIB,
                  {
                    label: t('edit'),
            ...
            React.createElement(
              'div',
              { className: 'lrow__meta', style: { margin: '14px 0' } },
              React.createElement(
                'span',
                { className: 'm-row', style: { gap: 5 } },
                React.createElement(MIcon, { name: 'mapPin', size: 14 }),
            ...
            React.createElement(
              ...
              React.createElement(
                'span',
                { className: 'm-muted', style: { fontSize: 'var(--text-xs)', fontWeight: 700 } },
    ...
    modal &&
      React.createElement(ClassModal, {
        draft: modal,
        setDraft: setModal,
    ...
    detail &&
      React.createElement(ClassDetailModal, {
        cls: detail,
...
function ClassDetailModal({ cls, onClose, onEdit }) {
  ...
  const Stat = (icon, label, val) =>
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(MIcon, { name: icon, size: 14 }),
        label,
      ),
      React.createElement(
        'div',
  ...
  return React.createElement(
    Modal,
    {
      ...
      footer: React.createElement(
        ...
        React.createElement(
          ...
          {
            variant: 'primary',
            iconLeft: React.createElement(MIcon, { name: 'edit', size: 16 }),
            onClick: onEdit,
          },
          t('cls_edit_class'),
        ),
    ...
    React.createElement(
      'div',
      { className: 'm-row', style: { gap: 10, marginBottom: 16 } },
      React.createElement(MTag, { color: cls.color }, cls.subject || t('cls_general')),
      React.createElement(
        'span',
        { className: 'm-row m-muted', style: { gap: 5, fontSize: 'var(--text-sm)' } },
        React.createElement(MIcon, { name: 'mapPin', size: 14 }),
    ...
    React.createElement(
      'div',
      { className: 'm-row', style: { gap: 10, marginBottom: 20 } },
    ...
    React.createElement(
      'div',
      { className: 'mochi-eyebrow', style: { marginBottom: 8 } },
    ...
    roster.length
      ? React.createElement(
          ...
          roster.map((s) =>
            React.createElement(
              'div',
              { key: s.id, className: 'm-row', style: { gap: 10, padding: '6px 4px' } },
      ...
      : React.createElement(
          'span',
          { className: 'm-muted', style: { fontSize: 'var(--text-sm)' } },
    ...
    materials.length > 0 &&
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'mochi-eyebrow', style: { margin: '4px 0 8px' } },
...
function ClassModal({ draft, setDraft, onClose, onSave, students }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { className: 'm-grid cols-2', style: { gap: 8, marginTop: 8 } },
      students.map((s) => {
...
function StudentsScreen() {
  ...
  return React.createElement(
    ...
    React.createElement(PageHeader, {
      ...
      actions: React.createElement(
        ...
        React.createElement(
          ...
          {
            variant: 'secondary',
            iconLeft: React.createElement(MIcon, { name: 'key', size: 17 }),
      ...
      React.createElement(
        ...
        data.students.map((s) =>
          React.createElement(
            ...
            React.createElement(
              'div',
              { className: 'tablebar', style: { maxWidth: 320, justifyContent: 'flex-end' } },
              classNames(s.classIds)
                .slice(0, 3)
                .map((n, i) => React.createElement(MTag, { key: i, dot: false }, n)),
              s.classIds.length > 3 &&
                React.createElement('span', { className: 'mchip' }, `+${s.classIds.length - 3}`),
            ),
            React.createElement(
              'div',
              ...
              React.createElement(
                MIB,
                { label: t('edit'), size: 'sm', onClick: () => setModal({ ...s }) },
                React.createElement(MIcon, { name: 'edit', size: 16 }),
              ),
              React.createElement(
                MIB,
                { label: t('delete'), size: 'sm', onClick: () => del(s) },
                React.createElement(MIcon, { name: 'trash', size: 16 }),
              ),
            ),
          ),
        ...
        data.users.map((u) =>
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'span',
                  { className: 'm-row', style: { gap: 5 } },
                  React.createElement(MIcon, { name: 'mail', size: 13 }),
                  u.email,
                ),
                u.phone &&
                  React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                MIB,
                { label: t('edit'), size: 'sm', onClick: () => setStaffModal({ ...u }) },
                React.createElement(MIcon, { name: 'edit', size: 16 }),
              ),
              React.createElement(
                MIB,
                { label: t('delete'), size: 'sm', onClick: () => delStaff(u) },
                React.createElement(MIcon, { name: 'trash', size: 16 }),
              ),
            ),
          ),
    ...
    tab === 'parents' &&
      React.createElement(
        ...
        (data.parents || []).length === 0 &&
          React.createElement('div', { className: 'm-empty' }, t('ppl_no_parents')),
        (data.parents || []).map((p) => {
          const kids = data.students.filter((s) => (p.studentIds || []).includes(s.id));
          return React.createElement(
            'div',
            { key: p.id, className: 'lrow' },
            ...
            React.createElement(
              ...
              kids.length
                ? kids
                    .slice(0, 3)
                    .map((s) => React.createElement(MTag, { key: s.id, color: s.color }, s.name))
                : React.createElement(
                    'span',
                    { className: 'm-muted', style: { fontSize: 'var(--text-sm)' } },
                    t('ppl_no_children'),
              ...
              kids.length > 3 &&
                React.createElement('span', { className: 'mchip' }, `+${kids.length - 3}`),
            ),
            ...
            React.createElement(
              ...
              React.createElement(
                MIB,
                { label: 'Edit', size: 'sm', onClick: () => setParentModal({ ...p }) },
                React.createElement(MIcon, { name: 'edit', size: 16 }),
              ),
              React.createElement(
                MIB,
                { label: 'Delete', size: 'sm', onClick: () => delParent(p) },
                React.createElement(MIcon, { name: 'trash', size: 16 }),
              ),
            ),
          );
    ...
    parentModal &&
      React.createElement(ParentModal, {
        draft: parentModal,
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'mochi-field' },
        React.createElement('label', { className: 'mochi-field__label' }, t('sm_grade')),
        React.createElement('input', {
          className: 'mochi-input',
          value: draft.grade,
    ...
    React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'mochi-field' },
        React.createElement('label', { className: 'mochi-field__label' }, t('sm_guardian')),
        React.createElement('input', {
          className: 'mochi-input',
    ...
    React.createElement(
      'div',
      { style: { marginTop: 8 } },
      React.createElement(TokenSearch, {
        items: classes,
...
function TokenSearch({ items, selectedIds, onToggle, placeholder, emptyHint }) {
  ...
  return React.createElement(
    'div',
    { className: 'tokensearch', ref: wrapRef },
    selected.length > 0 &&
      React.createElement(
        'div',
        { className: 'tablebar', style: { marginBottom: 8 } },
        selected.map((i) =>
          React.createElement(
            'button',
            {
    ...
    data.invites.map((inv) =>
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(MIcon, { name: 'key', size: 18 }),
        ),
        React.createElement(
          'div',
          { style: { flex: 1 } },
          React.createElement(
            ...
            React.createElement(
              MBadge,
              { color: inv.role === 'Parent' ? 'violet' : 'blue' },
              roleLabel(inv.role),
            ),
        ...
        React.createElement(
          ...
          !inv.used &&
            React.createElement(
              MBtn,
              {
                variant: 'soft',
                size: 'sm',
                iconLeft: React.createElement(MIcon, {
                  name: copied === inv.code ? 'check' : 'copy',
                  size: 15,
                }),
          ...
          React.createElement(
            MIB,
            { label: t('delete'), size: 'sm', onClick: () => remove('invites', inv.id) },
            React.createElement(MIcon, { name: 'trash', size: 16 }),
          ),
        ),
      ),
      ...
      footer: generated
        ...
        : React.createElement(
            ...
            React.createElement(
              ...
              {
                variant: 'primary',
                iconLeft: React.createElement(MIcon, { name: 'sparkle', size: 16 }),
                onClick: gen,
              },
              t('invm_generate'),
            ),
    ...
    generated
      ? React.createElement(
          ...
          React.createElement(
            ...
            {
              variant: 'soft',
              iconLeft: React.createElement(MIcon, { name: 'copy', size: 16 }),
              onClick: copy,
            },
            t('invm_copy_clip'),
          ),
