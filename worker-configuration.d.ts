/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9e8e6c91cfce0fd2db3ca0327e54773c)
// Runtime types generated with workerd@1.20260708.1 2026-06-23 nodejs_als
interface __BaseEnv_Env {
	...
	TRANSLATE_DO: DurableObjectNamespace<import("./workers/app").TranslateProxy>;
	LIVE_HUB: DurableObjectNamespace<import("./workers/app").LiveHub>;
	ZALO_POLLER: DurableObjectNamespace<import("./workers/app").ZaloPoller>;
	GAME_ROOM: DurableObjectNamespace<import("./workers/app").GameRoom>;
	RATE_LIMITER?: DurableObjectNamespace<import("./workers/app").RateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "TranslateProxy" | "LiveHub" | "ZaloPoller" | "RateLimiter" | "GameRoom";
	}
	interface TestEnv {
		FILES: R2Bucket;
		DB: D1Database;
