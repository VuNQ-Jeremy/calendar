...
import { decoyLetters, maskWord, meaningOf, pickRound, shuffle } from '@mochi/shared/logic/flashcards';
...
export function FillGame({ words, onExit, onFinish, endNote }: GameProps) {
  const th = useTheme();
  const { t } = useLang();
