...
## v0.0374 — 2026-09-04
fix(practice): the day menu on the sheet no longer opens behind the next date band
...
## v0.0354 — 2026-09-04
Practice pages now sit in the standard .content rail (they had no page padding) and carry a breadcrumb trail above the title. New PageHeader breadcrumbs prop + Breadcrumbs component in src/ui.tsx.
...
## v0.0339 — 2026-08-30
feat(landing): merge v2's structure and fresh copy into the main marketing site (facts band, pricing FAQ, about values, guide blurbs, SVG icons) in the original warm aesthetic; retire /v2
...
## v0.0317 — 2026-08-24
feat(checkin): the homework box appends a line per save instead of overwriting, plus an explicit Clear
...
## v0.0314 — 2026-08-23
feat(checkin): author next session's physical homework from this session's Check-in tab

## v0.0313 — 2026-08-23
fix(checkin): localize the assign-scope chip — it hard-coded the Vietnamese 'HS' in the English UI
...
## v0.0301 — 2026-08-22
Brand mark is now a real four-pad cat paw (filled), replacing Lucide's three-toe paw-print across the app, the favicon and the touch icon.
...
## v0.0292 — 2026-08-21
Public marketing landing page at / — bilingual VI/EN, warm Mochi brand, signup/login CTAs; signed-in visits still reach the app

## v0.0289 — 2026-08-18
fix(garden): the plant showcase was missing the page's padding rail entirely
...
## v0.0266 — 2026-08-18
The vocabulary grid sorts decks by book and unit number, so a book's units read 1, 2, 3 on the main list instead of newest first.
...
## v0.0263 — 2026-08-18
Vocabulary deck cards now carry the deck's colour instead of a dot beside the title, with the treatment (colour band, full colour, soft tint) picked in System Config as a third ui-prefs preset.
...
## v0.0237 — 2026-08-15
Usage tab now tracks the Anthropic API too: every enrich/generate call counts its input and output tokens (via the TranslateProxy DO, off the response path) and the new card shows calls, tokens and an estimated cost at haiku list prices
